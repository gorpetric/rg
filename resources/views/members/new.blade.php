...
<div class='container'>
    ...
    <form action='{{ route("members.new") }}' method='POST' autocomplete='off'>
        ...
        <input type='text' name='name' id='name' value='{{ Request::old("name") ?: '' }}'><br>
        <label for='address'>Adresa</label>
        <input type='text' name='address' id='address' value='{{ Request::old("address") ?: '' }}'><br>
        <label for='phone'>Kontakt broj</label>
        <input type='text' name='phone' id='phone' value='{{ Request::old("phone") ?: '' }}'><br>
